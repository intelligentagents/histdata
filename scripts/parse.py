...
import django
django.setup()
from core.models import Commit, Entity, Change, ENTITY_CHOICES, CHANGE_CHOICES
from core.utils import getType, formatDate, getState
...
with open('core/platform-sdk.csv', 'r') as f:
	next(f)
	for line in f:
		line = line.split(';')
		p = getState(line[4])
